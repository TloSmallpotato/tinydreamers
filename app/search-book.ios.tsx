...
export default function SearchBookScreen() {
  ...
  const handleAddToLibrary = async () => {
    if (!selectedBook) {
      console.log('[iOS] No book selected');
      return;
    }
    ...
    try {
      ...
      console.log('[iOS] Book title:', selectedBook.title);
      console.log('[iOS] Google Books ID:', selectedBook.googleBooksId);
      ...
      if (fetchError && fetchError.code === 'PGRST116') {
        ...
        console.log('[iOS] Cover URL:', selectedBook.coverUrl);
        console.log('[iOS] Thumbnail URL:', selectedBook.thumbnailUrl);
        console.log('[iOS] Source:', selectedBook.source);
